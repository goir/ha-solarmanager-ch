...
class Status(BaseModel):
    ...
    Status
    """
    installation_ongoing: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="installationOngoing")
    connected: Optional[Union[StrictFloat, StrictInt]] = None
    not_connected: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="notConnected")
    __properties = ["installationOngoing", "connected", "notConnected"]
    ...
    def from_dict(cls, obj: dict) -> Status:
        ...
        _obj = Status.parse_obj({
            "installation_ongoing": obj.get("installationOngoing"),
