...
class Model35(BaseModel):
    ...
    Model35
    """
    access_token: Optional[StrictStr] = Field(default=None, alias="accessToken", description="User access token")
    refresh_token: Optional[StrictStr] = Field(default=None, alias="refreshToken", description="User refresh token")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Model35:
        """Create an instance of Model35 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Model35:
        """Create an instance of Model35 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Model35.parse_obj(obj)

        _obj = Model35.parse_obj({
