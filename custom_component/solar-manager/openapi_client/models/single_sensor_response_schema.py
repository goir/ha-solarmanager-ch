...
class SingleSensorResponseSchema(BaseModel):
    """
    SingleSensorResponseSchema
    """
    ...
    created_at: Optional[date] = Field(default=None, alias="createdAt", description="time of creating the device")
    updated_at: Optional[date] = Field(default=None, alias="updatedAt", description="time of last updating the device")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SingleSensorResponseSchema:
        """Create an instance of SingleSensorResponseSchema from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SingleSensorResponseSchema:
        """Create an instance of SingleSensorResponseSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SingleSensorResponseSchema.parse_obj(obj)

        _obj = SingleSensorResponseSchema.parse_obj({
            "id": obj.get("_id"),
