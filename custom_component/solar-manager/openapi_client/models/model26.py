...
class Model26(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Model26:
        """Create an instance of Model26 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Model26:
        """Create an instance of Model26 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Model26.parse_obj(obj)

        _obj = Model26.parse_obj({
