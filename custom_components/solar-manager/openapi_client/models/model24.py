...
class Model24(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Model24:
        """Create an instance of Model24 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Model24:
        """Create an instance of Model24 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Model24.parse_obj(obj)

        _obj = Model24.parse_obj({
