...
class Model21(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Model21:
        """Create an instance of Model21 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Model21:
        """Create an instance of Model21 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Model21.parse_obj(obj)

        _obj = Model21.parse_obj({
