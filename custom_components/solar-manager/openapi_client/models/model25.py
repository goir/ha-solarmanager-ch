...
class Model25(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Model25:
        """Create an instance of Model25 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Model25:
        """Create an instance of Model25 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Model25.parse_obj(obj)

        _obj = Model25.parse_obj({
