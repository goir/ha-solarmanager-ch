...
class Model20(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Model20:
        """Create an instance of Model20 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Model20:
        """Create an instance of Model20 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Model20.parse_obj(obj)

        _obj = Model20.parse_obj({
