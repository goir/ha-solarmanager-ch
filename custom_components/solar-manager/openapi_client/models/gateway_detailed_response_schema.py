...
class GatewayDetailedResponseSchema(BaseModel):
    """
    GatewayDetailedResponseSchema
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GatewayDetailedResponseSchema:
        """Create an instance of GatewayDetailedResponseSchema from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GatewayDetailedResponseSchema:
        """Create an instance of GatewayDetailedResponseSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GatewayDetailedResponseSchema.parse_obj(obj)

        _obj = GatewayDetailedResponseSchema.parse_obj({
            "gateway": GatewayInfoSchema.from_dict(obj.get("gateway")) if obj.get("gateway") is not None else None,
            "settings": UserSettingsSchema.from_dict(obj.get("settings")) if obj.get("settings") is not None else None,
