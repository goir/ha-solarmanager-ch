...
class Model22(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Model22:
        """Create an instance of Model22 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Model22:
        """Create an instance of Model22 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Model22.parse_obj(obj)

        _obj = Model22.parse_obj({
